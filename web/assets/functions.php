...
';
    ...
    if($display_photoset) {
      ...
      $set_title = 'Hi there!';
      $set_desc = '<p>My name is Timo Kirkkala. I like to take pictures and I sometimes like to write code.</p><p>Browse to my photos from <a href="http://www.flickr.com/photos/kalak">flickr</a> on this page.<p>';
    }
